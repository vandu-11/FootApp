...
function Register() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch('http://3.27.73.81/Register_data', {
        method: 'POST',
        headers: {
        ...
        <form>
          <label>
            ...
            <input
              ...
              style={{ fontSize: '16px', width: '640px' }}
            />
          </label>
          <br />
          <label>
            ...
            <input
              ...
              style={{ fontSize: '25px', width: '645px' }}
            />
          </label>
          ...
          <div className={styles.inputContainer}>
              <label>
                ...
                <select
                  ...
                  style={{ fontSize: '16px', width: '650px' }}
                >
                  <option value="">Select any one</option>
          ...
          <label>
            ...
            <textarea
              ...
              style={{ fontSize: '16px', width: '620px' }}
            ></textarea>
          </label>
          <br />
          <div className={styles.ageContainer}>
  ...
  <div className={styles.inputContainer}>
    <label>
      ...
      <select
        ...
        style={{ fontSize: '16px', width: '270px' }}
      >
          ...
          <div>
            ...
            <label>
              ...
              <input
                ...
                style={{ fontSize: '16px', width: '630px' }}
              />
            </label>
            <br />
            <label>
              ...
              <select
                ...
                style={{ fontSize: '16px', width: '648px' }}
              >
                <option value="">Select any one</option>
